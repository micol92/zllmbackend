        ...
        sendMessage: function(payload){
            ...
            return new Promise((resolve, reject) => {
                ...
                for( let key in payload){
                    oActionODataContextBinding.setParameter(key, payload[key]);
                }
                oActionODataContextBinding.execute().then(
                    function(o) {
                        console.log(o)
                        var oActionContext = oActionODataContextBinding.getBoundContext();
                        var oReturnedContent = oActionContext.getObject().content;
                        if(oReturnedContent){
                            resolve(oReturnedContent);
                        } else {
                            reject(oReturnedContent);
                        }
                    }.bind(this)
                );
                */
